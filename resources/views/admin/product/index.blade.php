<x-layout>
    <div class="container">
        <div>
            <a href="{{ route('product.create') }}"><button class="btn btn-primary-p mb-4"> <i class="fa-solid fa-plus me-2"></i>Add New Product</button></a>
                ...
                <div class="card center-product me-3 mb-2">
                    ...
                    <div class="text-div">
                        ...
                        <div class="d-flex mt-2">
                            ...
                            <form action="{{route('product.destroy', $product)}}" method="POST" class="delete-form">
                                @csrf
                                @method('DELETE')
